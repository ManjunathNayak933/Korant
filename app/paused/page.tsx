  ...
  return (
    <div style={{ minHeight: '100vh', background: '#0d0d0d', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 24 }}>
      <div style={{ maxWidth: 400, textAlign: 'center' }}>
        <div style={{ fontSize: 16, fontWeight: 500, color: '#d4a843', marginBottom: 8 }}>MicroKorant</div>
        ...
        <p style={{ fontSize: 13, color: '#5a5652', marginBottom: 24, lineHeight: 1.7 }}>
          {user?.status_note || 'Your account has been temporarily paused. Please contact the MicroKorant team to restore access.'}
        </p>
        <div style={{ display: 'flex', gap: 12, justifyContent: 'center' }}>
          <a href="mailto:admin@microkorant.in" style={{ border: '0.5px solid #d4a843', color: '#d4a843', borderRadius: 7, padding: '8px 18px', fontSize: 13, textDecoration: 'none', display: 'inline-block' }}>Contact support</a>
